...
import com.module.emunicipalcorporation.Contacts.ContactModel;
import com.module.emunicipalcorporation.Contacts.CustomAdapter;
import com.module.emunicipalcorporation.Contacts.DbHelper;
import com.module.emunicipalcorporation.ShakeServices.ReactivateService;
import com.module.emunicipalcorporation.ShakeServices.SensorService;
...
//
//                Intent intent1 = new Intent(WomenSafety.this, ImageAudio.class);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (db.count() != 5) {
                    ...
                    Toast.makeText(WomenSafety.this, "Can't Add more than 5 Contacts", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
